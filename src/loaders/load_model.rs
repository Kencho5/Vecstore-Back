...
//{
//    println!("Loading MobileCLIP S1 model...");
//    let device = Device::Cpu;
//
//    let api = hf_hub::api::sync::Api::new()?;
//    let api = api.model("apple/MobileCLIP-S1-OpenCLIP".to_string());
//
//    let model_path = api.get("open_clip_model.safetensors")?;
//    let config = mobileclip::MobileClipConfig::s1();
//    let vb = unsafe { VarBuilder::from_mmaped_safetensors(&[model_path], DType::F32, &device)? };
//    let model = mobileclip::MobileClipModel::new(vb, &config)?;
//
//    println!("MobileCLIP S1 model loaded");
//
//    Ok((model, config))
//}
